...
keywordHandler:addKeyword({ "travel" }, StdModule.say, {
	...
	text = "So you want to leave this place? As you may have noticed, most seafarers won't stay here... for long. So, do you want me to send you back to {Ab'Dendriel}, {Darashia}, {Edron} or {Venore}?",
})
