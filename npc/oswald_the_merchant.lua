local internalNpcName = "Oswald the Merchant"
...
local function creatureSayCallback(npc, creature, type, message)
	...
	-- Remover a condição relacionada à quest storage
	-- Pode manter as outras condições, se desejar
...
npcHandler:setMessage(MESSAGE_GREET, "I sell and buy everything, say {trade}.")
npcHandler:setMessage(MESSAGE_FAREWELL, "Bye now, Neutrala |PLAYERNAME|. Visit old again one day!")
...
npcType.onSellItem = function(npc, player, itemId, subtype, amount, ignore, name, totalCost)
	player:sendTextMessage(MESSAGE_SENDTRADE, string.format("Sold %ix %s for %i gold.", amount, name, totalCost))
end
